...
<section class="video">
    <iframe src="https://www.youtube.com/embed/cyS0Lajmsbg?si=EyFL38VnHi97hQlM" title="YouTube video player"
        frameborder="0"
...
<section class="path">
    <div class="wrapper">
        ...
        <h3><span class="text-fancy-bg-gradient">BP Flow</span> c'est 3,2 M€
            d’économies identifiées dans des grands
            groupes.</h3>
        <ul>
